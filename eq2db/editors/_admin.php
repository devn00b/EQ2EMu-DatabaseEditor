...
?>
<div id="Editor">
<table width="1200" class="SubPanel" cellspacing="0" border="0">
	<tr>
	...
	<tr>
		<td valign="top"><!-- Left Menu -->
			<table class="SectionMenuLeft" cellspacing="0" border="0">
				<tr>
					<td class="SectionTitle">Project</td>
				</tr>
				...
				<tr>
					...
					<td class="SectionBody">
						<ul class="menu-list">
							<li class="<?= ( $page == "stats" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=stats">Server Stats</a></li>
							<li class="<?= ( $page == "soequests" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=soequests">SOE Quests</a></li>

							<?php if ($eq2->CheckAccess(G_SUPERADMIN)) : ?>
							<li class="<?= ( $page == "logs" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=logs">Log Files</a></li>
							<?php endif; ?>

							<?php if ($eq2->CheckAccess(M_ADMIN)) { ?>
							<li class="<?= ( $page == "changes" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=changes">Change Logs</a></li>
							<li class="<?= ( $page == "scripts" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=scripts">Validate Scripts</a></li>

							<?php if ($eq2->CheckAccess(G_SUPERADMIN)) { ?>
							<li class="<?= ( $page == "sql" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=sql">Adhoc SQL</a></li>
							<?php } ?>
							<?php } ?>
					</td>
				</tr>
				...
				<tr>
					<td class="SectionTitle">Migrate</td>
				</tr>

				<tr>
					<td class="SectionBody">
						<ul class="menu-list">
							<li class="<?= ( $page== "migrate" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=migrate">Migrate Zone</a></li>
							<li class="<?= ( $page == "purgezone" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=purgezone">Purge Zone</a></li>

							<?php if ($eq2->CheckAccess(M_ADMIN)) { ?>
							<li class="<?= ( $page == "popspells" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=popspells">Migrate Spells</a></li>
							<li class="<?= ( $page == "syncspells" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=syncspells">Sync Spells</a></li>
							<li class="<?= ( $page == "location" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=location">Migrate Locations</a></li>
							<?php } ?>
						</ul>
					</td>
				</tr>
				...
				<tr>
					<td class="SectionTitle">Scripting</td>
				</tr>

				<tr>
					<td class="SectionBody">
						<ul class="menu-list">
							<li class="<?= ( $page == "dialogs" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=dialogs">Build Dialogs</a></li>

							<?php if ($eq2->CheckAccess(A_TOOLDEV)) : ?>
							<li class="<?= ( $page == "movement" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=movement">Build Movement</a></li>
							<li class="<?= ( $page == "voiceovers" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=voiceovers">List Voiceovers</a></li>
							<?php endif ?>
						</ul>
					</td>
				</tr>
				...
				<tr>
					<td class="SectionTitle">Administration</td>
				</tr>
				...
				<tr>
					<td class="SectionBody">
						<ul class="menu-list">
							<?php if ($eq2->CheckAccess(G_SUPERADMIN)) { ?>
							<li class="<?= ( $page == "users" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=users">User Manager</a></li>
							<?php } ?>

							<li class="<?= ( $page == "reset" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=reset">Reset EQ2DB Server</a></li>

							<?php if ($eq2->CheckAccess(G_SUPERADMIN)) { ?>
							<li class="<?= ( $page == "compile" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=compile">Compile Source</a></li>
							<?php } ?>
						</ul>
					</td>
				</tr>
				...
				<?php if ($eq2->CheckAccess(M_ADMIN)) { ?>
				<tr>
					<td class="SectionTitle">In Dev</td>
				</tr>

				<tr>
					<td class="SectionBody">
						<ul class="menu-list">
							<li class="<?= ( $page== "pets" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=pets">Migrate Pets</a></li>
							<li class="<?= ( $page == "merchants" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=merchants">Compare Merchant Data</a></li>
							<li class="<?= ( $page == "popmerchant" ) ? "active-menu-list" : "menu-list" ?>">&raquo; <a href="<?php print($link) ?>?page=popmerchant">Merchant Data</a></li>
						</ul>
					</td>
				</tr>
...
function Welcome()
{
	...
	$eq2->SQLQuery = "SELECT * FROM site_text WHERE (type = 'welcome' AND subtype = 'admin') AND (is_active = 1 OR is_sticky = 1) ORDER BY created_date DESC";
		...
		<fieldset><legend>Required</legend>
			<table>
				...
				<tr>
					...
					<td>
					<?php
					$eq2->SQLQuery = "SHOW TABLES FROM " . DEV_DB;
					$results = $eq2->RunQueryMulti();
					?>
						<select name="querytable">
							<?php
							foreach($results as $row)
								printf("<option%s>%s</option>", ( $row["Tables_in_".DEV_DB] == ($_POST['querytable'] ?? "") ) ? " selected" : "", $row["Tables_in_".DEV_DB]);
							?>
						</select>
					</td>
			</table>
...
<table cellspacing="4" cellpadding="6">
	<tr>
		<td colspan="2" height="30">
			<strong>WARNING:</strong> This script copies the current spawns in EQ2 DB Project (<strong><?= strtoupper(DEV_DB) ?></strong>) over to EQ2 Test Center (<strong><?= strtoupper(LIVE_DB) ?></strong>). It can be used to keep updating LIVE with DEV work.<br />
			<strong>NOTE:</strong> This WILL PURGE the <?= strtoupper(LIVE_DB) ?> zone and overwrite existing content! Be careful.</td>
	</tr>
	<tr>
		<td align="right">Select <?= strtoupper(DEV_DB) ?> Zone to Copy to <?= strtoupper(LIVE_DB) ?>:</td>
